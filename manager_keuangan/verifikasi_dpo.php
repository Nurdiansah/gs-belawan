                ...
                <div class="table-responsive datatab">
                    <table class="table text-center table table-striped table-dark table-hover ">
                        ...
                        <tr>
                            ...
                            <td><b> (<?= formatRupiah($data2['nilai_pembulatan']); ?>)</b></td>
                        </tr>
                        <tr style="background-color :#B0C4DE;">
                ...
                <?php } else { ?>
                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe src="../file/pdfjs/web/viewer.html?file=../../foto/<?= $data2['foto_item']; ?> "></iframe>
                        ...
                        <div class="box-body">
                            <div class="form-group ">
                                <div class="col-sm-4">
                                    ...
                                    <input type="hidden" value="verifikasi_po" class="form-control" name="tab" readonly>
