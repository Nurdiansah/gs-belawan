...
if (isset($_GET['aksi']) && isset($_GET['id'])) {
    ...
    if ($_GET['aksi'] == 'lihat') {
        header("location:?p=verifikasi_dbo&id=$id");
        ...
        <div class="col-sm-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="text-center">Verifikasi Biaya Operasional</h3>
                </div>
                <div class="box-body">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    ?>
                                            ...
                                            <td> <button class="btn btn-success"><?= formatRupiah(round($row['nominal'])) ?> </button></td>
                                            <td>
                                                <a href="?p=verifikasi_biayaops&aksi=lihat&id=<?= $row['id']; ?>"><span data-placement='top' data-toggle='tooltip' title='Lihat'><button type="button" class="btn btn-warning"><i class="fa fa-search-plus"></i></button></span></a>
                                            </td>
                                            <!-- <td>
