<?php  
    ...
    include "../fungsi/fungsi.php";
        ...
        $queryDetail =  mysqli_query($koneksi, "SELECT * 
                                                ...
                                                WHERE db.kd_transaksi='$id' AND status = '2' ");
        ...
        $queryTotalH = mysqli_query($koneksi,"SELECT sum(harga_estimasi) as total FROM detail_biayaops WHERE kd_transaksi='$id' ");
        $rowTotalH=mysqli_fetch_assoc($queryTotalH);
        $totalPengajuan = $rowTotalH['total'];
    ...
    <div class="row">
        <div class="col-sm-12 col-xs-12">
            <div class="box box-primary">
                ...
                <form method="post" enctype="multipart/form-data" action="setuju_mr2.php" class="form-horizontal">
                ...
                <div class="table-responsive datatab"> 
                            <table class="table text-center table table-striped table-hover" border="2px;">
                                ...
                                <tr style="background-color :#B0C4DE;">
                                    ...
                                    <td><b><?= 'Rp. '.number_format($totalPengajuan,0,",",".");?></b></td>
                                    <td></td>
                                </tr>
                            </table>
                        </div>                        
