  ...
  <div class="row">
    ...
    <div class="col-lg-3 col-xs-6">
      <div class="list-group">
        ...
        <a href="index.php?p=approval_kasbon" class="list-group-item"> <i class="fa fa-check-square-o"></i> Approval <span class="badge label-info"><?php if ($dataKUV['jumlah'] >= 1) {
                                                                                                                                                      echo $dataKUV['jumlah'];
                                                                                                                                                    } ?></span></a>
        <a href="index.php?p=proses_kasbon&sp=kp_user" class="list-group-item"> <i class="fa fa-spinner"></i> Proses <span class="badge label-info"><?php echo $jumlahKP >= 1 ? $jumlahKP : ''; ?></span> </a>
        ...
        <a href="index.php?p=kasbon_transaksi&sp=kt_purchasing" class="list-group-item"> <i class="fa fa-bar-chart-o"></i> Transaksi <span class="badge label-success"><?php echo $jumlahKT >= 1 ? $jumlahKT : ''; ?></span></a>
      </div>
    </div>
    <div class="col-lg-3 col-xs-6">
      <div class="list-group">
    ...
    <div class="col-lg-3 col-xs-6">
      <div class="list-group">
        ...
        <a href="index.php?p=proses_bkk" class="list-group-item"> <i class="fa fa-spinner"></i> Proses <span class="badge label-info"><?php echo $dataBP['jumlah'] >= 1 ? $dataBP['jumlah'] : ''; ?></span></a>
        <a href="index.php?p=ditolak_bkk" class="list-group-item"> <i class="fa fa-close"></i> Ditolak <span class="badge label-danger"><?php if ($dataTolakBKK['jumlah'] > 0) {
