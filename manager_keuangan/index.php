...
if (!isset($_SESSION['username']) || $_SESSION['level'] != 'manager_keuangan') {
...
// query data proses
$queryProsesbno = mysqli_query($koneksi, "SELECT COUNT(id_bkk) AS jumlah_proses FROM bkk WHERE id_manager='$idUser' AND status_bkk BETWEEN '2' AND '8' AND status_bkk NOT IN ('101', '202', '303', '404', '505') ORDER BY tgl_bkk DESC  ");
...
// query AP
$queryAP = mysqli_query($koneksi, "SELECT COUNT(id_pettycash) AS jumlah FROM transaksi_pettycash tp   
                                                                        JOIN anggaran a
...
$queryKV1 = mysqli_query($koneksi, "SELECT COUNT(id_kasbon) AS jumlah FROM kasbon WHERE status_kasbon = '3' AND from_user='0'  AND sr_id IS NULL ");
$dataKV1 = mysqli_fetch_assoc($queryKV1);

// query proses Kasbon 2
$queryKV2 = mysqli_query($koneksi, "SELECT COUNT(id_kasbon) AS jumlah FROM kasbon WHERE (status_kasbon = '3' AND from_user = '1' )
                                                                                  OR (status_kasbon = '1' AND from_user = '1' AND id_manager='$idUser' AND vrf_pajak = 'as') ");
$dataKV2 = mysqli_fetch_assoc($queryKV2);

// query proses Kasbon 1
$queryKV3 = mysqli_query($koneksi, "SELECT COUNT(id_kasbon) AS jumlah FROM kasbon WHERE status_kasbon = '3' AND from_user='0'  AND sr_id IS NOT NULL ");
...
// bkk verifikasi
$queryBV = mysqli_query($koneksi, "SELECT COUNT(id) AS jumlah FROM bkk_final b    
                                                                JOIN anggaran a
...
// Biaya Operasional
$queryBK = mysqli_query($koneksi, "SELECT COUNT(id) AS jumlah FROM bkk_final WHERE status_bkk = '1' AND pengajuan = 'BIAYA KHUSUS' ");
$dataBK = mysqli_fetch_assoc($queryBK);

// Kasbon approval user
$queryKUV = mysqli_query($koneksi, "SELECT COUNT(id_kasbon) as jumlah  FROM kasbon WHERE status_kasbon =1 AND from_user = '1' AND id_manager='$idUser' AND vrf_pajak ='bp'
                                            ");
...
// Kasbon transaksi purchasing
$queryKTP = mysqli_query($koneksi, "SELECT COUNT(id_kasbon) as jumlah FROM kasbon WHERE status_kasbon = 8 AND from_user= '0' ");
$dataKTP = mysqli_fetch_assoc($queryKTP);

// Kasbon transaksi user
$queryKTU = mysqli_query($koneksi, "SELECT COUNT(id_kasbon) as jumlah  FROM kasbon WHERE status_kasbon = 8 AND from_user = '1' AND id_manager='$idUser' ");
...
$totalTolakKasbon = $dataKasbonTolak['jumlah'] + $dataTolakKSR['jumlah'];

$queryTolakBNO = mysqli_query($koneksi, "SELECT COUNT(id_bkk) as jumlah FROM bkk WHERE status_bkk = '404'");
$dataTolakBNO = mysqli_fetch_assoc($queryTolakBNO);

$queryTolakBKK = mysqli_query($koneksi, "SELECT COUNT(id) as jumlah FROM bkk_final WHERE status_bkk = '303' -- AND pengajuan = 'KASBON'");
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <?php if ($idUser == 54) { ?>
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <?php } ?>
                <li><a href="index.php?p=approval_bno"><i class="fa fa-calendar-check-o"></i> Biaya Umum</a></li>
                <?php if ($jkv > 0) { ?>
                  <span class="pull-right-container">
                    <span class="label label-info pull-right"><?= $jkv; ?></span>
                  </span>
                <?php } ?>
                <li><a href="index.php?p=verifikasi_biayaops"><i class="fa fa-dollar"></i> Biaya OPS</a></li>
                <?php if ($dataBK['jumlah'] > 0) { ?>
                  <span class="pull-right-container">
                    <span class="label label-success pull-right"><?= $dataBK['jumlah']; ?></span>
                  </span>
                <?php } ?>
                ...
                <?php } ?>
                <li><a href="index.php?p=verifikasi_po"><i class="fa fa-list"></i> PO</a></li>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <?php if ($dataKUV['jumlah'] > 0) { ?>
                <span class="pull-right-container">
                  <span class="label label-info pull-right"><?= $dataKUV['jumlah']; ?></span>
                </span>
              <?php } ?>
              <li><a href="index.php?p=approval_kasbon"><i class="fa fa-check-square-o"></i> Approval</a></li>
              <?php if ($jumlahKP > 0) { ?>
                <span class="pull-right-container">
                  <span class="label label-info pull-right"><?= $jumlahKP; ?></span>
                </span>
              <?php } ?>
              <li><a href="index.php?p=proses_kasbon&sp=kp_user"><i class="fa fa-spinner"></i> Proses</a></li>
              ...
              <?php if ($jumlahKT > 0) { ?>
                <span class="pull-right-container">
                  <span class="label label-success pull-right"><?= $jumlahKT; ?></span>
                </span>
              <?php } ?>
              <li><a href="index.php?p=kasbon_transaksi&sp=kt_purchasing"><i class="fa fa-bar-chart-o"></i> Transaksi</a></li>
            </ul>
          </li>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <?php if ($dataTolakPO['jumlah'] > 0) { ?>
                <span class="pull-right-container">
                  <span class="label label-info pull-right"><?= $dataTolakPO['jumlah']; ?></span>
                </span>
              <?php } ?>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <?php if ($dataTolakBKK['jumlah'] > 0) { ?>
                <span class="pull-right-container">
                  <span class="label label-danger pull-right"><?= $dataTolakBKK['jumlah']; ?></span>
                </span>
              <?php } ?>
