...
if (isset($_GET['aksi']) && isset($_GET['id'])) {
    ...
    if ($_GET['aksi'] == 'detail') {
        header("location:?p=approve_detailkaskeluar&id=$id");
...
$Dvs = $rowUser['id_divisi'];

$query = mysqli_query($koneksi, "SELECT * FROM bkk WHERE status_bkk='4' ORDER BY tgl_bkk DESC  ");
        ...
        <div class="col-sm-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="text-center">Approve Kas Keluar</h3>
                </div>
                <div class="box-body">
                    <div class="row">
                        <!-- <div class="col-md-2">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    ?>
                                            <td> <?= $no; ?> </td>
                                            <td> <?= $row['id_bkk']; ?> </td>
                                            <td> <?= tanggal_indo($row['tgl_pengajuankasir']); ?> </td>
                                            ...
                                            <td>
                                                <a href="?p=approve_kaskeluar&aksi=detail&id=<?= $row['id_bkk']; ?>"><span data-placement='top' data-toggle='tooltip' title='Lihat'><button class="btn btn-info">Detail</button></span></a>
