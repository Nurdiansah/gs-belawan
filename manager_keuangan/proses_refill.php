...
$query = mysqli_query($koneksi, "SELECT * FROM refill_funds WHERE status IN ('2', '3', '4', '5')");
        ...
        <div class="col-sm-12">
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    <h3 class="text-center">Proses Refill Fund</h3>
                </div>
                <div class="box-body">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    ?>
                                            ...
                                            <td><button class="btn btn-primary"><?= formatRupiah($row['nominal']); ?></button></td>
                                            <td>
                                                <?php if ($row['status'] == '2') {
                                                    ...
                                                    echo "<span class='label label-info'>Verifikasi Kasir</span>";
                                                }
                                                ?>
                                            </td>
                                            <td>
                                                <a href="index.php?p=dtl_prosesrefill&id=<?= enkripRambo($row['id_refill']) ?>"><button type="button" class="btn btn-success"><i class="fa fa-search-plus"></i> </button></a>
                                            </td>
                                </tr>
                        <?php
                                            $no++;
