...
$queryTolak = mysqli_query($koneksi, "SELECT * FROM tolak_bkk_final WHERE id_bkk_final = '$id'");
$dataTolak = mysqli_fetch_assoc($queryTolak);
?>
<section class="content">
    <div class="row">
        <div class="col-md-2">
            <a href="index.php?p=ditolak_bkk" class="btn btn-primary"><i class="fa fa-backward"></i> Kembali</a>
        </div>
        <br><br>
    </div>
    <div class="row">
        <div class="col-sm-12 col-xs-12">
            <div class="box box-primary">
                ...
                <div class="box-header with-border bg-info">
                    <h3 class="text-center">Detail BKK Ditolak</h3>
                </div>
                <br>
                <form method="post" action="simpan_bkk.php" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" disabled class="form-control is-valid" name="tgl_pengajuan" value="<?= formatTanggalWaktu($data2['created_on_bkk']); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="alasan_tolak" class="col-sm-offset- col-sm-1 control-label">Alasan Tolak</label>
                            <div class="col-sm-3">
                                <textarea rows="5" type="text" name="alasan_tolak" disabled class="form-control "> <?= $dataTolak['alasan_tolak_direktur']; ?></textarea>
                            </div>
                            <label for="waktu_tolak" class="col-sm-offset-2 col-sm-3 control-label">Waktu Tolak</label>
                            <div class="col-sm-3">
                                <b><input type="text" disabled class="form-control is-valid" name="waktu_tolak" value="<?= $dataTolak['waktu_tolak_direktur']; ?>"> </b>
                            </div>
                        </div>
                        <?php
                ...
                <div class="form-group ">
                    <!-- <button type="button" class="btn btn-primary col-sm-offset-1" data-toggle="modal" data-target="#escalate"> Escalate </button></span></a>
                        &nbsp; -->
                    <button type="button" class="btn btn-primary col-sm-offset-9" data-toggle="modal" data-target="#reapprove"> Approve </button></span></a>
                    &nbsp;
                    <button type="button" class="btn btn-danger " data-toggle="modal" data-target="#tolak"> Reject </button></span></a>
                    &nbsp;
                    <a target="_blank" href="bkk_new.php?id=<?= $data2['id_bkk_final']; ?>" class="btn btn-success"><i class="fa fa-print"></i> BKK</a>
                </div>
 ...
 -->
    ...
    <div class="collapse" id="clp-tagihan">
        <div class="box box-warning">
            ...
            <!-- Embed Document -->
            <?php if ($dataTagihan['doc_faktur'] != '') { ?>
                <!-- <div class="col-sm-12"> -->
                <div class="box-header with-border">
                    <h3 class="text-center">Invoice / Faktur </h3>
                    <div class="embed-responsive embed-responsive-4by3">
                        <iframe class="embed-responsive-item" src="../file/pdfjs/web/viewer.html?file=../../invoice/VFdjOVBRPT0faktur.pdf"></iframe>
                    </div>
                </div>
                <!-- </div> -->
            <?php } else { ?>
    ...
    <div id="reapprove" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <!-- konten modal-->
            <div class="modal-content">
                <!-- heading modal -->
                ...
                <!-- body modal -->
                <div class="modal-body">
                    <form method="post" enctype="multipart/form-data" action="reapprove_bkk.php" class="form-horizontal">
                        <div class="box-body">
                            <div class="form-group ">
                                <div class="col-sm-4">
                    ...
                    <form method="post" enctype="multipart/form-data" action="tolak_bkk.php" class="form-horizontal">
                        <div class="box-body">
                            <div class="form-group ">
                                <div class="col-sm-4">
                                    <input type="hidden" value="<?= $data2['id']; ?>" class="form-control" name="id" readonly>
                                    <input type="hidden" value="ditolak_bkk" class="form-control" name="url" readonly>
