...
if (isset($_POST['tolak'])) {
    ...
    // if ($dataTolak['alasan_tolak_mgrga'] == NULL && $dataTolak['alasan_tolak_pajak'] == NULL && $dataTolak['alasan_tolak_direktur'] == NULL) {
    ...
    $tolak = mysqli_multi_query($koneksi, "UPDATE kasbon SET status_kasbon = '4', komentar_mgr_ga = NULL
