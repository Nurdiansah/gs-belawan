                ...
                <?php } else { ?>
                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item" src="../file/pdfjs/web/viewer.html?file=../../foto/<?php echo $data2['foto_item']; ?> "></iframe>
                        </div>
                    </div>
                <?php } ?>
                <br>
                    ...
                    <form method="post" enctype="multipart/form-data" action="tolak_po.php" class="form-horizontal">
                        <div class="box-body">
                            <div class="form-group ">
                                <div class="col-sm-4">
                                    <input type="hidden" value="<?= $data2['id_po']; ?>" class="form-control" name="id_po" readonly>
                                    <input type="hidden" value="ditolak_po" class="form-control" name="tab" readonly>
                            ...
                            <div class="mb-3">
                                <label for="validationTextarea">Komentar</label>
                                <textarea rows="8" class="form-control is-invalid" name="komentar" id="validationTextarea" required autofocus></textarea>
                                <div class="invalid-feedback">
                                    Please enter a message in the textarea.
                                </div>
                            </div>
