        ...
        <div class="col-sm-12 ">
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    if (isset($_POST['cari'])) {
                    ?>
                        <a href="cetak_excel_summary.php?divisi=<?= enkripRambo($_POST['divisi']); ?>&tahun=<?= enkripRambo($_POST['tahun']); ?>" class="btn btn-success"><i class="fa fa-file-excel-o"></i> Excel</a>
                        <!-- <a href="cetak_excel_detail.php?divisi=<?= enkripRambo($_POST['divisi']); ?>&tahun=<?= enkripRambo($_POST['tahun']); ?>" class="btn btn-primary"><i class="fa fa-file-excel-o"></i> Detail</a> -->
                    <?php } else { ?>
