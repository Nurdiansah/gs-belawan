        ...
        <div class="col-sm-12">
            <div class="box box-primary">
                ...
                <ul class="nav nav-tabs">
                    <li role="presentation" class="<?php echo $sp == "tolak_purchasing" ? 'active' : ''; ?>"><a href="index.php?p=ditolak_kasbon&sp=tolak_purchasing">Kasbon MR <span class="badge label-warning"><?php echo $totalPurchasing > 0 ? $totalPurchasing : ''; ?></span></a></li>
                    <li role="presentation" class="<?php echo $sp == "tolak_sr" ? 'active' : ''; ?>"><a href="index.php?p=ditolak_kasbon&sp=tolak_sr">Kasbon SR <span class="badge label-warning"><?php echo $totalSR > 0 ? $totalSR : ''; ?></span></a></li>
