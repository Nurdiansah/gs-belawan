...
$query = mysqli_query($koneksi, "SELECT * 
                                            ...
                                            WHERE k.status_kasbon =1 AND from_user = '1' AND id_manager='$idUser' AND vrf_pajak ='bp'
                                            ");
                                ...
                                <tr>
                                    ...
                                    ?>
                                            ...
                                            <td><?php if ($row['status_kasbon'] == 1) { ?>
                                                    ...
                                                    <button type="button" class="btn btn-danger modalTolak " data-toggle="modal" data-target="#tolakKasbon" data-id="<?= $row['id_kasbon']; ?>"><i class="fa fa-reply"></i> Reject </button></span></a>
                                                <?php } ?>
                                            </td>
                                </tr>
                        <?php
...
<!-- Modal Reject -->
<div id="tolakKasbon" class="modal fade" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" enctype="multipart/form-data" action="tolak_kasbon.php" class="form-horizontal">
                    <div class="box-body">
                        <input type="hidden" name="id" id="mt_id_kasbon" value="">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="perhitungan">
                    <form method="post" name="form" enctype="multipart/form-data" action="setuju_kasbonbp.php" class="form-horizontal">
                        <div class="box-body">
