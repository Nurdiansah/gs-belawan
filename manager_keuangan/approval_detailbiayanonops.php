                ...
                ?>
                    ...
                    <div class="form-group"> -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <textarea type="text" rows="8" value="" class="form-control " name="keterangan" readonly><?= $row2['keterangan']; ?></textarea>
                                    </div>
                                    <!-- </div>
                    <div class="form-group"> -->
                                    <label for="terbilang_bkk" class=" col-sm-2 control-label">Terbilang</label>
                                    <div class="col-sm-3">
                                        <textarea type="text" rows="8" value="" class="form-control " name="terbilang_bkk" readonly><?= $row2['terbilang_bkk'] . ' Rupiah'; ?></textarea>
                                        <!-- <input type="text" value="" disabled class="form-control tanggal" name="terbilang_bkk"> -->
                                    </div>
                                </div>
                                <hr>
                                <div class="form-group">
                    ...
                    <div class="form-group"> -->
                        ...
                        <div class="box-header with-border">
                            ...
                            <!-- <div class="embed-responsive embed-responsive-16by9">
                                <iframe class="embed-responsive-item" src="../file/< echo $row2['invoice']; ?> "></iframe>
                            </div> -->
