...
if (isset($_GET['aksi']) && isset($_GET['id'])) {
    ...
    if ($_GET['aksi'] == 'edit') {
        header("location:?p=detail_srga&id=$id");
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Approval SR</li>
    </ol>
</section>
        ...
        <div class="col-sm-12 col-xs-12">
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    <h3 class="text-center">List Service Request</h3>
                </div>
                    ...
                    <table class="table text-center table table-striped table-hover" id="material">
                        ...
                        <tbody>
                            ...
                            ?>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#approveSr-<?= $row['id_sr']; ?>"><i class="fa fa-send"></i> Approve</button>
                                        <a href="?p=approval_srga&aksi=edit&id=<?= enkripRambo($row['id_sr']); ?>"><span data-placement='top' data-toggle='tooltip' title='Detail'><button class="btn btn-success"> <i class="fa fa-file-text-o"></i> Detail</button></span></a>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="perhitungan">
                                                        <form method="post" name="form" enctype="multipart/form-data" action="approve_srga.php" class="form-horizontal">
                                                            <div class="box-body">
                                                                <input type="hidden" name="id" value="<?= $row['id_sr']; ?>">
                                                                <input type="hidden" name="id_user" value="<?= $row['id_user']; ?> ">
                                                                <input type="hidden" name="id_manager" value="<?= $row['id_manager']; ?> ">
                                                                <h4>Apakah anda yakin ingin menyetujui service request <b><?= $row['nm_barang']; ?> ? </b></h4>
                                    ...
                                    <div id="rejectSr-<?= $row['id_sr']; ?>" class="modal fade" role="dialog">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <!-- body modal -->
                                                <div class="modal-body">
                                                    <form method="post" enctype="multipart/form-data" action="tolak_srga.php" class="form-horizontal">
                                                        <div class="box-body">
                                                            <input type="hidden" name="id_sr" id="id_sr" value="<?= $row['id_sr']; ?>">
                                                            <input type="hidden" name="url" id="url" value="approval_srga">
