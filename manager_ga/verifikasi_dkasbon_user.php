    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" enctype="multipart/form-data" action="setuju_kasbon_user.php" class="form-horizontal">
                    <div class="box-body">
                        <div class="form-group">
                        ...
                        <div class=" modal-footer">
                            <button class="btn btn-primary" type="submit" name="setuju">Yes</button></span>
                            &nbsp;
                    ...
                    <div class="box-body">
                        <div class="form-group ">
                            <div class="col-sm-4">
                                ...
                                <input type="hidden" name="url" id="url" value="verifikasi_kasbon&sp=vk_user">
