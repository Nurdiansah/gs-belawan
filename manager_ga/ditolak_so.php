...
if (isset($_GET['aksi']) && isset($_GET['id'])) {
    ...
    if ($_GET['aksi'] == 'edit') {
        header("location:?p=detail_sr&id=$id&pg=" . enkripRambo("ditolak_so") . "");
        ...
        <div class="col-sm-12 col-xs-12">
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    <h3 class="text-center">Service Order Ditolak</h3>
                </div>
                    ...
                    <table class="table text-center table table-striped table-hover" id="material">
                        ...
                        <tbody>
                            ...
                            ?>
                                    ...
                                    <td><?= $row['komentar']; ?></td>
                                    <td>
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#approveSO-<?= $row['id_so']; ?>"><i class="fa fa-undo"></i> Approve Kembali</button>
                                        <a href="?p=ditolak_so&aksi=edit&id=<?= enkripRambo($row['id_so']); ?>"><span data-placement='top' data-toggle='tooltip'><button class="btn btn-success"> <i class="fa fa-file-text-o"></i> Detail</button></span></a>
                                    ...
                                    <!-- Modal release -->
                                    <div id="approveSO-<?= $row['id_so']; ?>" class="modal fade" role="dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="perhitungan">
                                                        <form method="post" name="form" enctype="multipart/form-data" action="approve_kembali_so.php" class="form-horizontal">
                                                            <div class="box-body">
                                                                <input type="hidden" name="id" value="<?= $row['id_so']; ?>">
                                                                <input type="hidden" name="id_user" value="<?= $row['id_user']; ?> ">
                                                                <input type="hidden" name="id_manager" value="<?= $row['id_manager']; ?> ">
                                                                <h4>Apakah anda yakin ingin menyetujui kembali service request <b><?= $row['nm_barang']; ?> ? </b></h4>
                                                ...
                                                <div class="modal-body">
                                                    <form method="post" enctype="multipart/form-data" action="tolak_so.php" class="form-horizontal">
                                                        <div class="box-body">
                                                            ...
                                                            <input type="hidden" name="url" id="url" value="ditolak_so">
