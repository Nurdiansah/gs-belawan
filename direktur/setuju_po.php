...
if (isset($_GET['id'])) {
    ...
    if (!isset($id_direktur)) {
        ...
        $query1 = mysqli_query($koneksi, "UPDATE po
    									  SET app_direksi = '$tanggal', id_direktur = '$idUser'
    									  WHERE id_po = '$id_po' ");
        ...
        while ($dataUser = mysqli_fetch_assoc($queryUser)) {
            $link = "url=index.php?p=verifikasi_po&lvl=kasir";
            $name = $dataUser['nama'];
            $email = $dataUser['email'];
            $subject = "Payment PO [" . $dataEmail['po_number'] . "]";
            $body = addslashes("<font style='font-family: Courier;'>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td style='font-family: Courier;'>: " . $dataEmail['app_direksi'] . "</td>
                                    </tr>
                                    <tr>
