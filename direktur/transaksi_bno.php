...
if (isset($_GET['aksi']) && isset($_GET['id'])) {
    ...
    if ($_GET['aksi'] == 'edit') {
        header("location:?p=transaksi_dbno&id=$id");
...
$query = mysqli_query($koneksi,  "SELECT * 
                                ...
                                WHERE b.status_bkk='9' ORDER BY b.kd_transaksi DESC  ");
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    ?>
                                            ...
                                            <td>
                                                <a href="?p=transaksi_bno&aksi=edit&id=<?= $row['id_bkk']; ?>"><span data-placement='top' data-toggle='tooltip' title='Lihat'><button class="btn btn-info">Lihat</button></span></a>
                                            </td>
                                </tr>
                        <?php
                                            $no++;
