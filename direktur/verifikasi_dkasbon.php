    ...
    <div class="row">
        <div class="col-sm-12 col-xs-12">
            <div class="box box-primary">
                <div class="row">
                    <!-- <div class="col-md-2">
                            <a href="index.php?p=verifikasi_kasbon&id=<?= $data['kd_transaksi']; ?>" class="btn btn-primary"><i class="fa fa-backward"></i> Kembali</a> 
                        </div> -->
                    <br><br>
                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="input-group">
                                            ...
                                            <input type="text" disabled class="form-control is-valid" name="harga" value="<?= formatRupiah($data['harga_akhir']); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group ">
            ...
            <div class="box-header with-border">
                <!-- <div class="form-group">   -->
                <h4 class="text-left"><b>Total Budget <?= '<font color="blue">' . $nm_item . '</font>' . ' Setahun : ' . formatRupiah($totalAnggaran); ?> &nbsp;</b></b></h4>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" enctype="multipart/form-data" action="setuju_kasbon.php" class="form-horizontal">
                    ...
                    <input type="hidden" value="verifikasi_kasbon&sp=vk_purchasing" name="url">
                    <div class="box-body">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" enctype="multipart/form-data" action="tolakdirektur_kasbon.php" class="form-horizontal">
                    <input type="hidden" value="vk_purchasing" class="form-control" name="tab" readonly>
                    <div class="box-body">
                        <div class="form-group ">
                            <div class="col-sm-4">
                                ...
                                <input type="hidden" value="verifikasi_kasbon&sp=vk_purchasing" class="form-control" name="url" readonly>
                            </div>
                        </div>
