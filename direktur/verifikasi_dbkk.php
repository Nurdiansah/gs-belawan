...
$queryReapp = mysqli_query($koneksi, "SELECT * FROM reapprove_bkk_final WHERE id_bkk_final = '$id'");
            ...
            <div class="box box-primary">
                ...
                <form method="post" enctype="multipart/form-data" class="form-horizontal">
                    <div class="box-body">
                        ...
                        <?php if ($totalReapp > 0) { ?>
                            <div class="form-group">
                                <label for="" class="col-sm-offset- col-sm-1 control-label">Alasan Setuju Kembali</label>
                                <div class="col-sm-3">
                                    <textarea rows="5" name="alasan_reapp" class="form-control" disabled><?= $dataReapp['alasan_reapprove_kasir']; ?>&#13;&#10;<?= $dataReapp['alasan_reapprove_mgrfin']; ?>&#13;&#10;<?= $dataReapp['alasan_reapprove_pajak']; ?></textarea>
                                </div>

                                <!-- <label for="" class="col-sm-offset-2 col-sm-3 control-label">Waktu Setuju Kembali</label>
                                <div class="col-sm-3">
                                    <textarea name="alasan_reapp" class="form-control" disabled><?= $dataReapp['waktu_reapprove_kasir']; ?>&#13;&#10;<?= $dataReapp['waktu_reapprove_mgrfin']; ?>&#13;&#10;<?= $dataReapp['waktu_reapprove_pajak']; ?></textarea>
                                </div> -->
                            </div>
                        <?php } ?>
                        <br>
                ...
                <?php
                if ($data2['pengajuan'] == 'KASBON' && $data['from_user'] == '0') { ?>
                    <div class="row">
                ...
                <?php if ($data2['pengajuan'] == 'KASBON' && $dataKU['from_user'] == '1') { ?>
                    <div class="row">
                        <div class="col-sm-offset-10 col-sm-1">
                ...
                <div class="box box-warning">
                    ...
                    <div class="form-group"> -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <textarea rows="8" type="text" value="" class="form-control " name="keterangan" readonly><?= $dataBU['keterangan']; ?></textarea>
                                </div>
                                <!-- </div>
                    <div class="form-group"> -->
                                <label for="terbilang_bkk" class=" col-sm-2 control-label">Terbilang</label>
                                <div class="col-sm-3">
                                    <textarea rows="8" type="text" value="" class="form-control " name="keterangan" readonly><?= $dataBU['terbilang_bkk'] . ' Rupiah'; ?></textarea>
                                </div>
                            </div>
                            <?php if ($totalReapp > 0) { ?>
                                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-sm-7">
                            ...
                            <div class="embed-responsive embed-responsive-4by3">
                                <iframe class="embed-responsive-item" src="../file/<?php echo $dataBU['invoice']; ?> "></iframe>
                            </div>
                        </div>
                        <div class="col-sm-4">
                ...
                <div class="box box-warning">
                    ...
                    <div class="table-responsive datatab">
                        <table class="table text-center table table-striped table-dark table-hover ">
                            ...
                            <tr style="background-color :#B0C4DE;">
                                ...
                                <td><b> <?= formatRupiah($dataPO['sub_totalpo']); ?></b></td>
                            </tr>
                            <tr>
                                <td colspan="5"><b>Diskon </b></td>
                                <td><b> <?= formatRupiah($dataPO['diskon_po']); ?></b></td>
                            </tr>
                            <?php
                            ...
                            <tr>
                                <td colspan="5"><b> Nilai <?= $dataPO['nm_pph']; ?> </b></td>
                                <td><b> (<?= formatRupiah($dataPO['nilai_pph']); ?>)</b></td>
                            </tr>
                            <tr style="background-color :#B0C4DE;">
                                <td colspan="5"><b> Grand Total </b></td>
                                <td><b> <?= formatRupiah($dataPO['grand_totalpo']); ?></b></td>
                            </tr>
                                </tbody>
                        </table>
                    </div>
                    ...
                    <?php } else { ?>
                        <div class="col-sm-6">
                            <div class="box-header with-border">
                                ...
                                <div class="embed-responsive embed-responsive-4by3">
                                    <iframe class="embed-responsive-item" src="../file/foto/<?= $dataPO['foto_item']; ?>"></iframe>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
                    ...
                    <div class="col-sm-6">
                        <div class="box-header with-border">
                            ...
                            <div class="embed-responsive embed-responsive-4by3">
                                <iframe class="embed-responsive-item" src="../file/doc_quotation/<?php echo $dataPO['doc_quotation']; ?> "></iframe>
                            </div>
                        </div>
                    </div>
                    <br>
                    <div class="box-header with-border">
                        <h3 class="text-center">Document Penawaran</h3>
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item" src="../file/doc_penawaran/<?php echo $dataPO['doc_penawaran']; ?> "></iframe>
                        </div>
                    </div>
                    <br>
                ...
                <div class="modal-body">
                    <form method="post" enctype="multipart/form-data" action="setuju_bkk3.php" class="form-horizontal">
                        <div class="box-body">
                            ...
                            <input type="hidden" name="jenis_bu" value="<?= $dataBU['jenis']; ?>">
                            <input type="hidden" name="pengajuan" value="<?= $data2['pengajuan']; ?>">
                            <input type="hidden" name="bulan" value="<?= $data2['created_on_bkk']; ?>">
