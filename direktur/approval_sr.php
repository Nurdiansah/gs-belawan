...
$queryData =  mysqli_query($koneksi, "SELECT *, s.created_by as yg_buat
                                        ...
                                        WHERE s.status = '4'
                                        AND (direktur1 != '$idUser' OR direktur1 IS NULL)
...
if (isset($_GET['aksi']) && isset($_GET['id'])) {
    ...
    if ($_GET['aksi'] == 'edit') {
        header("location:?p=detail_sr&id=$id&pg=" . enkripRambo("approval_sr") . "");
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Approval SO</li>
    </ol>
</section>
                    ...
                    <table class="table text-center table table-striped table-hover" id="material">
                        ...
                        <tbody>
                            ...
                            ?>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#approveSO-<?= $row['id_so']; ?>"><i class="fa fa-send"></i> Approve</button>
                                        <a href="?p=approval_sr&aksi=edit&id=<?= enkripRambo($row['id_so']); ?>"><span data-placement='top' data-toggle='tooltip'><button class="btn btn-success"> <i class="fa fa-file-text-o"></i> Detail</button></span></a>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="perhitungan">
                                                        <form method="post" name="form" enctype="multipart/form-data" action="approve_so.php" class="form-horizontal">
                                                            <div class="box-body">
                                                ...
                                                <div class="modal-body">
                                                    <form method="post" enctype="multipart/form-data" action="tolak_so.php" class="form-horizontal">
                                                        <div class="box-body">
                                                            ...
                                                            <input type="hidden" name="url" id="url" value="approval_sr">
                                                            <div class="mb-3">
