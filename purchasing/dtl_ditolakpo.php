...
if (isset($_POST['update'])) {
    ...
    if ($query) {
        header("location:index.php?p=dtl_ditolakpo&id_po=$id_po");
    } else {
        ...
        <div class="col-sm-12 col-xs-12">
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    <h3 class="text-center">Detail PO Ditolak</h3>
                </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" enctype="multipart/form-data" action="reapprove_po.php" class="form-horizontal">
                    <div class="box-body">
                        <input type="hidden" value="<?= $data['id_po']; ?>" class="form-control" name="id_po">
                        ...
                        <input type="hidden" class="form-control is-valid" name="kd_transaksi" value="<?= $data['kd_transaksi']; ?>">
                        <input type="hidden" class="form-control is-valid" name="harga" value="<?= $total; ?>">
                        <input type="hidden" name="url" value="ditolak_mr&sp=ditolak_po">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control select2 " name="id_supplier" required>
                                    ...
                                    ?>
                                        <option value="<?= $rowSupplier['id_supplier']; ?>" <?php if ($data['id_supplier'] == $rowSupplier['id_supplier']) {
                                                                                                echo "selected=selected";
                                                                                            } ?>><?= $rowSupplier['nm_supplier']; ?></option>
                                    <?php endwhile; ?>
                                </select>
                            </div>
                        </div>
