...
if (isset($_POST['update'])) {
    ...
    if ($query) {
        header("location:index.php?p=dtl_submitpo&id_po=$id_po");
    } else {
        ...
        <div class="col-sm-12 col-xs-12">
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    <h3 class="text-center">Detail Submit Kembali PO</h3>
                </div>
            ...
            <div class="modal-body">
                <form method="POST" enctype="multipart/form-data" action="reapprove_po.php" class="form-horizontal">
                    <div class="box-body">
                        ...
                        <input type="hidden" name="url" value="submit_kembali_po">
                        <div class="form-group">
