...
if (isset($_GET['aksi']) && isset($_GET['id'])) {
    ...
    if ($_GET['aksi'] == 'revisi') {
        ...
        header("location:?p=lpj_dpetty&id=$id");
...
$query = mysqli_query($koneksi, "SELECT *, tp.id_pettycash, tp.created_pettycash_on, tp.keterangan_pettycash, a.kd_anggaran, tp.total_pettycash, tp.status_pettycash
                                        ...
                                        WHERE tp.status_pettycash IN (3, 101) AND (tp.from = 'sr' OR tp.from = 'mr')
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td> <?php if ($row['status_pettycash'] == 3) { ?>
                                                    ...
                                                    <?php  } else if ($row['status_pettycash'] == 101) { ?>
                                                        <span class="label label-danger">Pengajuan Ditolak </span>
                                                        &nbsp; <br> <br> <a href="?p=lpj_petty&aksi=revisi&id=<?= $row['id_pettycash']; ?>"><span data-placement='top' data-toggle='tooltip' title='Revisi'><button type="button" class="btn btn-primary"><i class="fa fa-edit"> </i> Revisi</button></span></a>
                                                        <a href="?p=lpj_petty&aksi=lpj&id=<?= $row['id_pettycash']; ?>"><span data-placement='top' data-toggle='tooltip' title='LPJ'><button type="button" class="btn btn-success"><i class="fa fa-edit"> </i> LPJ</button></span></a>
                                                    <?php  } ?>
                                                </td>
                                            </tr>
