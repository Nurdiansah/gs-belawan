...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="index.php?p=lpj_kasbon&sp=lpj_ksr">Daftar Kasbon SR</a></li>
...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-2 col-xs-3">
            <a href="index.php?p=lpj_kasbon&sp=lpj_ksr" class="btn btn-success"><i class="fa fa-backward"></i> Kembali</a>
        </div>
        <div class="col-sm-2 col-sm-offset-8 col-xs-offset-2 col-xs-3">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#approveSr"><i class="fa fa-send"></i> Kirim LPJ </button>
        </div>
        <br><br>
    </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" enctype="multipart/form-data" action="lpj_kasbon_sr.php" class="form-horizontal">
                        <div class="box-body">
                            <div class="form-group ">
                                <div class="col-sm-4">
                                    <input type="hidden" value="<?= $data['harga_akhir']; ?>" class="form-control" name="harga" readonly>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" required class="form-control " name="pph_persen" value="0" id="pph_persen" disabled />
