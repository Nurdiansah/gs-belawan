...
if (isset($_POST['update'])) {
    ...
    if ($query) {
        header("location:index.php?p=dtl_kasbonditolak&id_kasbon=$id_kasbon");
    } else {
            ...
            <div class="modal-body">
                <form method="POST" enctype="multipart/form-data" action="reapprove_kasbon.php" class="form-horizontal">
                    <div class="box-body">
                        ...
                        <input type="hidden" required class="form-control is-valid" name="status" value="<?= $data['status_kasbon']; ?>">
                    ...
                    <div class="box-body">
                        <div class="form-group ">
                            <div class="col-sm-4">
                                ...
                                <input type="hidden" value="ditolak_mr&sp=ditolak_kasbon" name="url">
                            </div>
                        </div>
