...
<h4 align="" style="font-size: 12px;"><u>KODE ID : [ <?= $data['po_number']; ?> ]</u></h4>
<!-- <table border="1px">
    <tr>
        <td> -->
<table border="0" style="font-size: 11px;">
    ...
    <tr>
        <td><b>Nominal</b></td>
        <td>:</td>
        <td><?= formatRupiah($data['grand_totalpo']) ?></td>
    </tr>
    <tr>
        <td><b>Terbilang</b></td>
        <td>:</td>
        <td style="width=420px;"><?= Terbilang($data['grand_totalpo']) ?> Rupiah</td>
    </tr>
    <tr>
        <td><b>Dibuat</b></td>
        <td>:</td>
        <td><?= formatTanggalWaktu($data['tgl_po']); ?></td>
    </tr>
    <tr>
...
<table border="0" style="font-size: 10px;">
    <tr>
        ...
        <th style="text-align: center; width=350px;">Penerima<br><br><br><br><br>(<?= $data['nm_supplier']; ?>)</th>
    </tr>
</table>
...
try {
    ...
    $html2pdf->Output('Laporan-Pengambilan-Dana-PO-' . $id . '.pdf');
