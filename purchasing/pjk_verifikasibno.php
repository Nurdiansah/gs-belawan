...
if (isset($_GET['aksi']) && isset($_GET['id'])) {
    ...
    if ($_GET['aksi'] == 'detail') {
        header("location:?p=pjk_detailverifikasibno&id=$id");
...
$query = mysqli_query($koneksi, "SELECT * 
                                ...
                                WHERE b.status_bkk='3' ORDER BY b.kd_transaksi DESC  ");
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    ?>
                                            ...
                                            <td>
                                                <a href="?p=pjk_verifikasibno&aksi=detail&id=<?= $row['id_bkk']; ?>"><span data-placement='top' data-toggle='tooltip' title='Lihat'><button class="btn btn-info">Detail</button></span></a>
