                ...
                <form method="post" enctype="multipart/form-data" class="form-horizontal">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <label for="nominal_pengajuan" class="col-sm-offset-2 col-sm-3 control-label">Total Pengajuan</label>
                            <div class="col-sm-3">
                                <input type="text" disabled class="form-control is-valid" name="nominal_pengajuan" value="<?= formatRupiah($data2['nominal_pengajuan']); ?>">
                            </div>
                            ...
                            <label for="penambahan" class="col-sm-offset-2 col-sm-3 control-label">Penambahan</label>
                            <div class="col-sm-3">
                                <input type="text" disabled class="form-control is-valid" name="penambahan" value="<?= formatRupiah($data2['penambahan']); ?>">
                            </div>
                            <label for="total_pettycash" class="col-sm-offset-2 col-sm-3 control-label">Grand Total</label>
                            <div class="col-sm-3">
                                <b><input type="text" disabled class="form-control is-valid" name="total_pettycash" value="<?= formatRupiah($data2['total_pettycash']); ?>"> </b>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="keterangan" class="col-sm-offset- col-sm-1 control-label">Nama Barang</label>
                            <div class="col-sm-3">
                                <textarea rows="5" type="text" name="keterangan" disabled class="form-control "> <?= $data2['nm_barang']; ?></textarea>
                            </div>
                        </div>
                        <br>
                    </div>
