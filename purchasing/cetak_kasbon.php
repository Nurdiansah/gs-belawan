...
<h1 align="center"><u>KAS BON [ <?= $data['id_kasbon'] ?> ]</u></h1>
<table border="0px">
  <tr>
...
<div class="tablekiri">
  <table border="1px">
    ...
    <tr>
      ...
      <td style="text-align: center; width=100px;"> <br><?php if ($data['status_kasbon'] >= 2) { ?><img src="../gambar/approved.jpg" alt="" width="100"> <?php  }  ?> </td>
      <td style="text-align: center; width=100px;"> <br><?php if ($data['status_kasbon'] >= 5) { ?> <img src="../gambar/approved.jpg" alt="" width="100"> <?php  }  ?> </td>
      <td style="text-align: center; width=100px;"> <br><?php if ($data['status_kasbon'] >= 5) { ?> <img src="../gambar/approved.jpg" alt="" width="100"> <?php  }  ?> </td>
      <td style="text-align: center; width=120px; height=100px;"> <br><?php if ($data['status_kasbon'] >= 3) { ?> <img src="../gambar/approved.jpg" alt="" width="100"> <?php  }  ?> </td>
      <td style="text-align: center; width=120px;"><br><br> <?php if ($data['status_kasbon'] >= 7) { ?> <img src="../gambar/kasir.png" alt="" width="100"> <?php  }  ?> </td>
      <td style="text-align: center; width=120px;"><br><br> <?php if ($data['status_kasbon'] >= 8) { ?> <img src="../gambar/kasir.png" alt="" width="100"> <?php  }  ?> </td>
    </tr>
    <tr>
