<?php  
	...
	if(isset($_POST['submit'])) {		
		...
		$query = "INSERT INTO supplier ( nm_supplier, kota_supplier, alamat_supplier , no_telponsupplier, no_faxsupplier, email_supplier) VALUES 
										( '$nm_supplier', '$kota_supplier', '$alamat_supplier', '$no_telponsupplier', '$no_faxsupplier', '$email_supplier');
			";
