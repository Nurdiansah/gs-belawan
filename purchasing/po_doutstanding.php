...
if (isset($_POST['submit'])) {
    ...
    $queryUpdate = mysqli_query($koneksi, "UPDATE po SET status_po = '6'
                                            WHERE id_po = '$id_po'");
    ...
    if ($queryUpdate) {
        ...
        setcookie('pesan', 'PO gagal di submit!' . mysqli_error($koneksi), time() + (3), '/');
            ...
            <div class="box box-primary">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-xs-12">
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#konfirmasi"><i class="fa fa-send"></i> Submit </button></span></a>
                                        ...
                                        <div class="perhitungan">
                                            <form method="post" name="form" enctype="multipart/form-data" action="" class="form-horizontal">
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group ">
                                                        <!-- <div class="col-sm-4"> -->
                                                        <h4 class="text-center">Apakah anda yakin ingin mensubmit untuk melakukan pembayaran selanjutnya ? </h4>
                                                        <!-- </div> -->
                                                    </div>
