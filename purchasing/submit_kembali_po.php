        ...
        <div class="col-sm-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="text-center">Submit Kembali PO</h3>
                </div>
                        ...
                        <tbody>
                            <?php while ($dataPO = mysqli_fetch_assoc($queryPO)) { ?>
                                <tr>
                                    ...
                                    <td><?= $dataPO['tgl_po']; ?></td>
                                    <th><span class="label label-danger">Diajukan kembali oleh admin divisi</span></th>
                                    <td>
                                        <a href="index.php?p=dtl_submitpo&id_po=<?= $dataPO['id_po']; ?>" class="btn btn-primary " title="Lihat"> Lihat</a>
