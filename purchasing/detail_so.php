...
$queryDSR =  mysqli_query($koneksi, "SELECT *  FROM detail_sr ds
                                        INNER JOIN so so
                                            ON so.sr_id = ds.sr_id
                                        WHERE id_so = $id ");
    ...
    <div class="row">
                        ...
                        <div class="perhitungan">
                            <div class="form-group ">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="nominal" id="nominal" autocomplete="off" value="<?= formatRupiah2($data['nominal']); ?>" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" required>
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        <span class="input-group-addon ">Rp.</span>
                                        <input type="text" class="form-control" name="diskon_sr" id="diskon_sr" value="<?= formatRupiah2($data['diskon']); ?>" placeholder="0" required onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group ">
        ...
        <div class="col-sm-6 col-xs-12">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <?php if ($isiDoc == 1 || $data['doc_penawaran'] == NULL) {
            ...
            <!-- <div class="box box-primary">
                ...
                <div class="box-body">
                    <?php if ($isiDocQt == 1 || $data['doc_quotation'] == NULL) { ?>
                        <div class="embed-responsive embed-responsive-16by9">
