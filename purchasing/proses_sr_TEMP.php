                                ...
                                ?>
                                        ...
                                        <td>
                                            ...
                                            <?php } elseif ($row['status'] == 5) { ?>
                                                <a target="_blank" onclick="window.open('cetak_pengambilandana_so.php?id=<?= enkripRambo($row['id_so']); ?>','name','width=800,height=600')" class="btn btn-success"><i class="fa fa-print"></i> LPD </a>
