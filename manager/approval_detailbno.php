                ...
                ?>
                    ...
                    <div class="form-group"> -->
                        ...
                        <div class="box-header with-border">
                            ...
                            <br>
                            <br>
                            <div class="col-sm-offset-8 col-sm-5 control-label">
                                <h4> Verifikasi </h4>
                                ...
                                <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#tolaktax">Reject To Tax</button></span></a>
                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#tolakuser">Reject To User</button></span></a>
                            </div>
                            <!-- </div> -->
                        </div>
            </div>
