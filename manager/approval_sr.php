                        ...
                        <tbody>
                            ...
                            ?>
                                    ...
                                    <td>
                                        ...
                                        <a href="?p=approval_sr&aksi=edit&id=<?= enkripRambo($row['id_sr']); ?>"><span data-placement='top' data-toggle='tooltip' title='Detail'><button class="btn btn-success"> <i class="fa fa-file-text-o"></i> Detail</button></span></a>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="perhitungan">
                                                        <form method="post" name="form" enctype="multipart/form-data" action="approve_sr.php" class="form-horizontal">
                                                            <div class="box-body">
