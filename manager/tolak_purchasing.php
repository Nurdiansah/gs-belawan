<div class="table-responsive">
    <table class="table text-center table table-striped table-hover" id="">
        ...
        <tbody>
            <?php while ($dataUser = mysqli_fetch_assoc($queryPurchasing)) { ?>
                <tr>
                    <td><?= $no; ?></td>
                    ...
                    <td>
                        ...
                        <?= $dataUser['alasan_tolak_mgrga']; ?><br>
                        <?= $dataUser['alasan_tolak_pajak']; ?>
                    </td>
                    <td>
                        <?= $dataUser['waktu_tolak_direktur']; ?><br>
                        <?= $dataUser['waktu_tolak_mgrfin']; ?><br>
                        <?= $dataUser['waktu_tolak_mgrga']; ?><br>
                        <?= $dataUser['waktu_tolak_pajak']; ?>
                    </td>
                    <td>
                        <a href="index.php?p=dtl_kasbonditolak&id=<?= $dataUser['id_kasbon']; ?>" class="btn btn-primary " title="Lihat"> Lihat</a>
                        <!-- <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#approve_<?= $dataUser['id_kasbon']; ?>" title="Setuju"><i class="fa fa-check"></i></button>
                                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#tolak_<?= $dataUser['id_kasbon']; ?>" title="Tolak"><i class="fa fa-close"></i></button> -->
                    </td>
                </tr>
                <!-- MODAL TOLAK REMBO YG IKUT NGELOOPING -->
                <div id="tolak_<?= $dataUser['id_kasbon']; ?>" class="modal fade" role="dialog">
                                ...
                                <form method="POST" enctype="multipart/form-data" action="tolakmgrfin_kasbon.php" class="form-horizontal">
                                    <div class="box-body">
                                        <div class="form-group ">
                                            <div class="col-sm-4">
                                                <input type="hidden" value="<?= $dataUser['id_kasbon']; ?>" class="form-control" name="id_kasbon">
                                            </div>
                                        </div>
                ...
                <!-- MODAL BUAT SETUJU -->
                <div id="approve_<?= $dataUser['id_kasbon']; ?>" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        <!-- konten modal-->
                        <div class="modal-content">
                            <!-- heading modal -->
