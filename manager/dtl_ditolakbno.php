            ...
            <div class="box box-primary">
                ...
                ?>
                    ...
                    <div class="form-group"> -->
                                ...
                                <div class="form-group">
                                    <label for="reapprove_manager" class="col-sm-2 control-label">Alasan Tolak Manager Fin</label>
                                    <div class="col-sm-3">
                                        <textarea class="form-control" name="reapprove_manager" disabled><?= $row2['komentar_mgrfin']; ?></textarea>
                                    </div>

                                    <label for="reapprove_managerfin" class="col-sm-2 control-label">Alasan Tolak Direktur</label>
                                    <div class="col-sm-3">
                                        <textarea class="form-control" name="reapprove_managerfin" disabled><?= $row2['komentar_direktur']; ?></textarea>
                                    </div>
                                </div>
                                <hr>
                                <div class="form-group">
