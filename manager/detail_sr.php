...
if (isset($_POST['update'])) {
    ...
    if ($doc_ba == '') {
        ...
        if ($ekstensi != 'pdf') {
            ...
            header("location:index.php?p=edit_sr&id=" . enkripRambo($id));
        }
...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-2">
            <a href="index.php?p=approval_sr" class="btn btn-primary"><i class="fa fa-backward"></i> Kembali</a>
        </div>
        <br><br>
    </div>
    <div class="row">
        ...
        <div class="col-sm-6 col-xs-12">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <!-- pdf baru -->
                    <iframe src="../file/pdfjs/web/viewer.html?file=../../doc_pendukung/<?php echo $data['doc_ba']; ?> " frameborder="0" width="100%" height="400"></iframe>
