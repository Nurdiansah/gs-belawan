<?php  
    ...
    if (isset($_GET['aksi']) && isset($_GET['id'])) {
        ...
        $query = mysqli_query($koneksi, "SELECT * 
                                            ...
                                            WHERE bo.status_biayaops = '3' ORDER BY bo.kd_transaksi DESC   ");                                                
                				...
                				<tr>
                					<?php 
                					 ...
                					 ?>
                                        ...
                                        <td> <?= $row['nm_divisi']; ?> </td>                                        
                						<td>
                                        <a href="?p=list_order&aksi=lihat&id=<?= $row['kd_transaksi']; ?>"><span data-placement='top' data-toggle='tooltip' title='Lihat'><button  class="btn btn-info">Lihat</button></span></a>                     
                                        </td>              					
                				</tr>
                            <?php                        
                            $no++; endwhile; } ?>
