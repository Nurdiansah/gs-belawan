    ...
    <div class="row">
        <div class="col-sm-12 col-xs-12">
            <div class="box box-primary">
                ...
                <form method="post" name="form" action="auto_edit_item_tolak.php" enctype="multipart/form-data" class="form-horizontal">
                    <div class="box-body">
    ...
    <div class="modal-dialog lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" enctype="multipart/form-data" action="add_subdboedit.php" class="form-horizontal">
                    <div class="box-body">
