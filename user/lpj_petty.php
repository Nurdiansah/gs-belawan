                ...
                <form method="post" name="form" action="upd_revisi_petty.php" enctype="multipart/form-data" class="form-horizontal">
                    <div class="box-body">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-3">
                                <input name="id" type="text" class="form-control" value="<?= $data['id_pettycash']; ?>" readonly>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="mb-3">
                                ...
                                <div class="col-sm-8">
                                    <textarea rows="8" class="form-control is-invalid" name="keterangan" id="validationTextarea" readonly placeholder="Deskripsi"><?= $data['keterangan_pettycash']; ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" enctype="multipart/form-data" action="upd_lpj_petty.php" class="form-horizontal">
                    <div class="box-body">
                        <div class="form-group ">
                            <div class="col-sm-4">
                                <input type="hidden" value="<?= $data['total_pettycash']; ?>" class="form-control" name="hargaawal" readonly>
