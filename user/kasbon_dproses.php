        ...
        <div class="col-sm-12 col-xs-12">
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    <h3 class="text-center">Detail MR</h3>
                </div>
                <form method="post" name="form" action="#" enctype="multipart/form-data" class="form-horizontal">
                    <div class="box-body">
                        ...
                        <div class="mb-2">
                            <label for="validationTextarea">Keteangan :</label>
...
<script>
    $(document).ready(function() {
        ...
        if (app_manager_ga == "01 Jan 1970 07:00") {
            app_manager_ga = " ";
        ...
        if (status == '1') {
            ...
            // var content_direktur = "<b>Direktur</b><font color= blue ><small>Verifikasi Direktur </small></font> <i class='fa fa-bicycle'></i>";
        }
