...
$queryUser =  mysqli_query($koneksi, "SELECT area, id_divisi from user WHERE username  = '$_SESSION[username_blw]'");
        ...
        <div class="col-sm-12 col-xs-12">
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    <h3 class="text-center">Tambah Anggaran</h3>
                </div>
                    ...
                    <div class="form-group"> -->
                            ...
                            <div class="col-sm-3">
                                <select name="id_tahun" class="form-control">
                                    ...
                                    ?>
                                            <option value="<?= $rowtahun['id_tahun']; ?>" type="checkbox"><?= $rowtahun['nm_tahun']; ?></option>
                                    <?php endwhile;
                                    } ?>
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <!-- </div>
                        <div class="form-group"> -->
                            <label id="tes" for="kd_transaksi" class="col-sm-2 control-label">Kode Transaksi</label>
                            <div class="col-sm-3">
                        ...
                        <div class="form-group"> -->
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" required class="form-control " name="harga" id="harga_nominal" />
                                    </div>
                                </div>
                            </div>
                            <hr>
