...
$queryProses = mysqli_query($koneksi, "SELECT COUNT(id_bkk) AS jumlah_proses FROM bkk WHERE status_bkk IN (0, 1, 2, 3, 4, 5, 6, 7, 101, 202, 303, 404) AND status_bkk NOT IN ('101', '202') AND id_divisi='$idDivisi' ");
