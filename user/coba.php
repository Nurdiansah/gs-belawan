...
<head>
    ...
    <!-- Link Chosen -->
  <link rel="stylesheet" type="text/css" href="../assets/plugins/jquery/chosen.css" >
</head>
<body>
<?php  
                ...
                <form method="post" name="form" action="add_biayanonops.php" enctype="multipart/form-data" class="form-horizontal">
					...
					<div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                            <select   class="kode" name="id_anggaran" >
...
<script src="../assets/plugins/jQuery/chosen.jquery.js"></script>
<script>
  $(document).ready(function(){
           $(".kode").chosen();
    });
