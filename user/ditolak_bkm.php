                                                            ...
                                                            <form method="post" name="form" enctype="multipart/form-data" action="" class="form-horizontal">
                                                                ...
                                                                <div class="box-body">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <textarea rows="8" class="form-control is-invalid" name="ditolak" id="validationTextarea" placeholder="Deskripsi Kas Masuk" disabled><?= $dataBKM['komentar_pajak']; ?>&#13;&#10;<?= $dataBKM['komentar_kasir']; ?>&#13;&#10;<?= $dataBKM['komentar_costcontrol']; ?>&#13;&#10;<?= $dataBKM['komentar_manager']; ?></textarea>
                                                                    </div>
                                                                    <div class="form-group">
