<?php  
    ...
    if (isset($_GET['aksi']) && isset($_GET['id'])) {
        ...
        if ($_GET['aksi'] == 'edit') {
            header("location:?p=detail_lihatkaskeluar&id=$id");
        ...
        $query = mysqli_query($koneksi, "SELECT * FROM bkk WHERE status_bkk = '7' AND id_divisi = '$id_divisi' ORDER BY tgl_bkk DESC  ");    
                				...
                				<tr>
                					<?php 
                					 ...
                					 ?>
                						...
                						<td>
                                            <a href="?p=lihat_kaskeluar&aksi=edit&id=<?= $row['id_bkk']; ?>"><span data-placement='top' data-toggle='tooltip' title='Lihat'><button  class="btn btn-info">Lihat</button></span></a>                     
