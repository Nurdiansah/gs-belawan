...
if (isset($_POST['update'])) {
    ...
    if ($doc_ba == '') {
        ...
        if ($ekstensi != 'pdf') {
            ...
            header("location:index.php?p=edit_so&id=" . enkripRambo($id) . "&pg=" . $_GET['pg']);
        }
    ...
    $keterangan = $_POST['keterangan'];
    // Update sr
    $return = mysqli_query($koneksi, "UPDATE so SET nm_barang = '$nm_barang',                                                                                                        
        ...
        <div class="col-sm-6 col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="text-center">Edit Service Order</h3>
                </div>
            ...
            <div class="modal-body">
                <form method="post" enctype="multipart/form-data" action="add_dsr.php" class="form-horizontal">
                    <div class="box-body">
                        ...
                        <input type="hidden" name="url" value="edit_so">
                        <div class="form-group">
