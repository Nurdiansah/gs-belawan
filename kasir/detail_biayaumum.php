...
$queryBkk = mysqli_query($koneksi, "SELECT * , CONCAT(kd_pt, '.', kd_parent, '.', kd_divisi, '.', kd_programkerja) AS program_kerja, nm_item
                                    FROM bkk b
                                    JOIN anggaran a
            ...
            <div class="box box-primary">
                ...
                ?>
                    ...
                    <div class="form-group"> -->
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" value="<?= $row2['nm_item'] . ' - [' . $row2['program_kerja']; ?>]" class="form-control " name="kd_transaksi" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
