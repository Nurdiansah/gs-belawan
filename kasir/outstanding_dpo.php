    ...
    <div class="row">
        <div class="col-sm-12 col-xs-12">
            <div class="box box-primary">
                <div class="row">
                        <div class="col-md-2">
                            <a href="index.php?p=outstanding_po" class="btn btn-primary"><i class="fa fa-backward"></i> Kembali</a> 
                        </div>
                        <br><br>
                </div> 
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Verifikasi Outstanding PO</h4>
                        </div>
                        <!-- body modal -->
                        <div class="modal-body">
                            <div class="perhitungan">
                            <form method="post" name="form" enctype="multipart/form-data" action="add_outstanding.php" class="form-horizontal">
                                <div class="box-body">
                                    ...
                                    <div class="form-group ">
                                        <label id="tes"for="persentase_pembayaran" class="col-sm-5 control-label">Grand Total</label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group ">
                                        <label id="tes"for="persentase_pembayaran" class="col-sm-5 control-label">Pembayaran 1</label>
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                <span class="input-group-addon">Rp.</span>
                                                <input type="text" class="form-control " name="nominal_pembayaran1" id="nominal_pembayaran1" value ="<?= formatRupiah2($data2['nominal_pembayaran1']);?>" readonly>
                                            </div>                                             
                                        </div>
                                    </div>                                                     
                                    <hr>                   
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                <span class="input-group-addon">Rp.</span>
                                                <input type="text" class="form-control " name="nominal_pembayaran2" id="nominal_pembayaran2" value ="<?= formatRupiah2($sisaPembayaran );?>" readonly>
                                            </div>                                             
                                        </div>
                                    </div>   
                                    <div class="form-group ">
