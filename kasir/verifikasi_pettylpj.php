...
if (isset($_GET['aksi']) && isset($_GET['id'])) {
    ...
    if ($_GET['aksi'] == 'lihat') {
        header("location:?p=verifikasi_dpettylpj&id=$id");
        ...
        <div class="col-sm-12">
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    <h3 class="text-center">Verifikasi LPJ Petty Cash</h3>
                </div>
                <div class="box-body">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    ?>
                                            ...
                                            <td>
                                                <a href="?p=verifikasi_pettylpj&aksi=lihat&id=<?= $row['id_pettycash']; ?>"><span data-placement='top' data-toggle='tooltip' title='Lihat'><button class="btn btn-info"><i class="fa fa-search-plus"></i></button></span></a>
                                            </td>
                                </tr>
                        <?php
                                            $no++;
