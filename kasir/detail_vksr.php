...
<section class="content-header">
    <h1>
        Verifikasi LPJ
        <small>Kasbon Service Request</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="?pg=dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="index.php?p=verifikasi_kasbonlpj&sp=vlk_sr">Daftar Verifikasi LPJ Kasbon SR</a></li>
...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-2 col-xs-3">
            <a href="index.php?p=verifikasi_kasbonlpj&sp=vlk_sr" class="btn btn-success"><i class="fa fa-backward"></i> Kembali</a>
        </div>
        <div class="col-sm-3 col-sm-offset-7 col-xs-offset-2 col-xs-3">
            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#rejectSr"><i class="fa fa-reply"></i> Reject</button>
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#approveSr"><i class="fa fa-send"></i> Konfirmasi </button>
        </div>
        <br><br>
    </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" enctype="multipart/form-data" action="tolak_lpj_sr.php" class="form-horizontal">
                        <div class="box-body">
                            <input type="hidden" name="id" id="id" value="<?= $data['id_kasbon']; ?>">
                            <input type="hidden" name="url" id="url" value="verifikasi_kasbonlpj&sp=vlk_sr">
                            <div class="mb-3">
    ...
    <div id="approveSr" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <!-- body modal -->
                <div class="modal-body">
                    <form method="post" enctype="multipart/form-data" action="setuju_lpj_kasbonsr.php" class="form-horizontal">
                        <div class="box-body">
                            <div class="form-group ">
                                <div class="col-sm-4">
                                    <input type="hidden" value="<?= $data['id_kasbon']; ?>" class="form-control" name="id_kasbon" readonly>
                                    <input type="hidden" value="<?= $data['harga_akhir']; ?>" class="form-control" name="total" readonly>
    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-xs-12">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="../file/doc_lpj/<?= $data['doc_lpj']; ?>"></iframe>
                    </div>
                </div>
                <br>
            </div>
