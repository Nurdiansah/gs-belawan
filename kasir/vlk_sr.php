            ...
            <tbody>
                <tr>
                    ...
                    ?>
                            ...
                            <td>
                                <a href="?p=detail_vksr&id=<?= enkripRambo($row['sr_id']); ?>"><span data-placement='top' data-toggle='tooltip' title='Lihat'><button type="button" class="btn btn-warning"><i class="fa fa-search-plus"></i></button></span></a>
                            </td>
                </tr>
        <?php
                            $no++;
