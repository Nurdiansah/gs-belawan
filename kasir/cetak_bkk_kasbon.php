...
$queryBkk = mysqli_query($koneksi, "SELECT * 
                                          FROM kasbon k
                                          JOIN biaya_ops b
                                          ON k.kd_transaksi = b.kd_transaksi
...
?>
  ...
  <table>
    ...
    <tr>
      <td>Terbilang </td>
      <td>: <?= Terbilang($row['harga_akhir']); ?> </td>
      <td></td>
      <td>NO.Cek/Giro </td>
      <td>: <?= $row['no_cekbkk']; ?></td>
    </tr>
  ...
  <table class="tabel2 text-center">
    ...
    <tr>
      ...
      <td style="text-align: center; " width=80 px;><br><?= formatRupiah($row['harga_akhir']); ?></td>
    </tr>
  </table>
  ...
  <table class="tabel2 text-center">
    ...
    <tr>
      ...
      <td style="text-align: center; " width="150px;">Disetujui/Tgl <br> <br><img src="../gambar/ttd_bosia.jpeg" width="50px;"> <br> <br> (Indra Anwar) <br>Direktur</td>
      <td style="text-align: center; " width="5px;"></td>
