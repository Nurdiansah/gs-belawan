        ...
        <div class="col-sm-12 col-xs-12">
            <div class="box box-primary">
                ...
                <form method="POST" action="simpan_bkk.php" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <br>
                                <!-- <input type="submit" name="simpan" value="Simpan Perubahan" class="btn btn-warning"> -->
                                <button type="submit" name="simpan" class="btn btn-warning"><i class="fa fa-save"></i> Simpan</button>
                            </div>
                        </div>
                ...
                <!-- 
                 ...
                 -->
                <div class="form-group ">
                    <button type="button" class="btn btn-success col-sm-offset-9" data-toggle="modal" data-target="#reapprove"><i class="fa fa-send"></i> Ajukan Kembali </button></span></a>
                    &nbsp;
                        ...
                        <div class="table-responsive datatab">
                            <table class="table text-center table table-striped table-dark table-hover ">
                                ...
                                <?php
                                            ...
                                            $grandTotalKP = ($total + $data['nilai_ppn']) - $data['nilai_pph']; ?>
                                ...
                                <tr style="background-color :#B0C4DE;">
                                    ...
                                    <td><b><?= formatRupiah($grandTotalKP); ?></b></td>
                                </tr>
                                    </tbody>
                            </table>
                        </div>
