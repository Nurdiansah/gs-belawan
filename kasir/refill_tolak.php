...
if (isset($_POST['update'])) {
    ...
    if ($nominal <= 0) {
        ...
        if (empty($_FILES['doc_pendukung']['name'])) {
            ...
            if ($return) {
                ...
                setcookie('pesan', 'Pengajuan Berhasil dirubah!', time() + (3), '/');
    ...
    header("location:index.php?p=refill_tolak&id=" . enkripRambo($id_refill));
}
...
$query =  mysqli_query($koneksi, "SELECT * FROM refill_funds
                                    LEFT JOIN tolak_refill
                                        ON id_refill = refill_id
                                    WHERE id_refill = '$id' ");
...
<section class="content">
    ...
    <a href="index.php?p=refill_proses" class="btn btn-primary"><i class="fa fa-backward"></i> Kembali</a>
    <br><br>
    <div class="row">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="datetime-local" class="form-control " name="created_at" value="<?= $data['created_at']; ?>" autocomplete=" off" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label id="tes" for="alasan_ditolak" class="col-sm-offset-1 col-sm-3 control-label">Alasan Ditolak </label>
                            <div class="col-sm-7">
                                <div class="form-floating">
                                    <textarea class="form-control" name="alasan_ditolak" id="floatingTextarea2" style="height: 210px" disabled><?= $data['komentar']; ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
