...
$queryKu = mysqli_query($koneksi, "SELECT * 
                                    ...
                                    WHERE k.status_kasbon = '7' AND from_user = '1'
        ...
        <tbody>
            <tr>
                ...
                ?>
                        ...
                        <td>
                            <a href="?p=payment_dkasbon_user&id=<?= $row['id_kasbon']; ?>"><span data-placement='top' data-toggle='tooltip' title='Lihat'><button class="btn btn-info">Lihat</button></span></a>
                        </td>
            </tr>
    <?php
                        $no++;
