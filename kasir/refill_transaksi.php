...
$query = mysqli_query($koneksi, "SELECT * FROM refill_funds WHERE status = '6'");
        ...
        <div class="col-sm-12">
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    <h3 class="text-center">Transaksi Refill Fund </h3>
                </div>
                <div class="box-body">
                        ...
                        <table class="table text-center table table-striped table-hover" id="<?php echo $jumlahData > 0 ? 'material' : ''; ?>">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    ?>
                                            <td>
                                                <a href="index.php?p=refill_show&id=<?= enkripRambo($row['id_refill']) ?>&back=refill_transaksi"><?= orderNumber($row['id_refill']);  ?></a>
                                            </td>
