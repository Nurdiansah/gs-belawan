        ...
        <tbody>
            <tr>
                ...
                ?>
                        ...
                        <td>
                            <a href="index.php?p=pending_dkasbon_sr&id=<?= $row['id_kasbon']; ?>"><span data-placement='top' data-toggle='tooltip' title='Lihat'><button type="button" class="btn btn-warning"><i class="fa fa-search-plus"></i></button></span></a>
                        </td>
            </tr>
    <?php
                        $no++;
                ...
                $jumlahData  = mysqli_num_rows($querySR);
                if ($jumlahData == 0) {
                    echo
                    "<tr>
