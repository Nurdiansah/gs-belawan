                ...
                <tr>
                    ...
                    ?>
                            ...
                            <td> <button type="button" class="btn btn-success">
                                    <b><?= formatRupiah($row['harga_akhir']) ?></b>
                                </button></td>
                            <td>
                                <a href="?p=detail_pksr&id=<?= enkripRambo($row['sr_id']); ?>"><span data-placement='top' data-toggle='tooltip' title='Lihat'><button type="button" class="btn btn-warning"><i class="fa fa-search-plus"></i></button></span></a>
                            </td>
                </tr>
        <?php
                            $no++;
