...
if (isset($_POST['simpan'])) {
    ...
    $tgl_tempo = $_POST['tgl_tempo'] == "" ? "0000-00-00" : $_POST['tgl_tempo'];
    $tgl_payment = $_POST['tgl_payment'] == "" ? "0000-00-00" : $_POST['tgl_payment'];
    $id_divisi = $_POST['id_divisi'];

    $queryUser =  mysqli_query($koneksi, "SELECT * from user u
											JOIN divisi d
												ON u.id_divisi = d.id_divisi
											WHERE u.id_divisi  = '$id_divisi' AND u.level = 'admin_divisi' ");
    ...
    $query = "INSERT INTO bkk (nm_vendor, kd_transaksi, tgl_pengajuan, terbilang_bkk, id_anggaran, keterangan, nilai_barang, nilai_jasa, ppn_persen, ppn_nilai, pph_persen, pph_nilai, jml_bkk, jenis, metode_pembayaran, tgl_tempo, tgl_payment,bank_tujuan, norek_tujuan, penerima_tujuan, id_pemohon, id_divisi, id_manager,invoice, status_bkk) VALUES 
							('$nm_vendor', '$kode_otomatis', '$tgl_bkk',  '$terbilang_bkk', '$id_anggaran', '$keterangan', '$nilai_barang', '$nilai_jasa', '$ppn_persen',' $ppn_nilai', '$pph_persen','$pph_nilai','$jml_bkk', '$jenis', '$metode_pembayaran', '$tgl_tempo', '$tgl_payment', '$bank_tujuan', '$norek_tujuan', '$penerima_tujuan','$id_user', '$id_divisi', '$id_manager','$namabaru', '-1');
			";
    ...
    header("location:index.php?p=biaya_umum");
}
