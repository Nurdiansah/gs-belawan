...
if (isset($_GET['aksi']) && isset($_GET['id'])) {
    ...
    if ($_GET['aksi'] == 'edit') {
        header("location:?p=detail_sr&id=$id&pg=" . enkripRambo("transaksi_sr") . "");
                            ...
                            <tbody>
                                ...
                                ?>
                                        ...
                                        <td>
                                            ...
                                            <a href="?p=transaksi_sr&aksi=edit&id=<?= enkripRambo($row['id_so']); ?>"><span data-placement='top' data-toggle='tooltip'><button class="btn btn-info"> <i></i> Lihat</button></span></a>
                                        ...
                                        <div class="perhitungan">
                                            <form method="POST" name="form" enctype="multipart/form-data" action="payment_so.php" class="form-horizontal">
                                                <div class="box-body">
                                                    ...
                                                    <input type="hidden" name="url" id="url" value="transaksi_sr">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <!-- <input type="file" name="doc_pembayaran"> -->
                                                    </div>
                                                    <br><br><br>
