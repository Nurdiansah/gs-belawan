        ...
        <div class="col-sm-12 col-xs-12">
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    <h3 class="text-center">Detail Invoice PO Ditolak</h3>
                </div>
                <form method="post" enctype="multipart/form-data" class="form-horizontal" action="">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <textarea rows="5" type="text" name="alasan_tolak" disabled class="form-control "><?= $data2['alasan_tolak_mgrfin']; ?>&#13;&#10;<?= $data2['alasan_tolak_direktur']; ?></textarea>
                            </div>
                            <label for="waktu_tolak" class="col-sm-offset-2 col-sm-3 control-label">Waktu Tolak</label>
                            <div class="col-sm-3">
                                <textarea rows="5" type="text" name="alasan_tolak" disabled class="form-control "><?= $data2['waktu_tolak_mgrfin']; ?>&#13;&#10;<?= $data2['waktu_tolak_direktur']; ?></textarea>
                            </div>
                        </div>
                        <br>
                    </div>
                    ...
                    <div class="col-sm-6 col-xs-12">
                        <div class="box box-primary">
                            ...
                            <div class="perhitungan">
                                ...
                                <form method="post" name="form" action="reapprove_po.php" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <select name="id_pph" class="form-control" id="id_pph" value="<?= $data2['bf_id_pph'] ?>">
                                                ...
                                                ?>
                                                        <option value="<?= $rowPph['id_pph']; ?>" data-id="<?= $rowPph['jenis']; ?>" type="checkbox" <?php if ($rowPph['id_pph'] == $data2['bf_id_pph']) {
