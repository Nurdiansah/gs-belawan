...
if (isset($_GET['aksi']) && isset($_GET['id'])) {
    ...
    if ($_GET['aksi'] == 'edit') {
        header("location:?p=detail_sr&id=$id");
    } else if ($_GET['aksi'] == 'release') {
        header("location:rls_so.php?id=$id");
    } else if ($_GET['aksi'] == 'hapus') {
        header("location:del_so.php?id=$id");
    }
}
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Verifikasi SO</li>
    </ol>
</section>
                    ...
                    <table class="table text-center table table-striped table-hover" id="material">
                        ...
                        <tbody>
                            ...
                            ?>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#approveSo-<?= $row['id_so']; ?>"><i class="fa fa-send"></i> Verifikasi</button>
                                        <a href="?p=verifikasi_sr&aksi=edit&id=<?= enkripRambo($row['id_so']); ?>"><span data-placement='top' data-toggle='tooltip' title='Detail'><button class="btn btn-success"> <i class="fa fa-file-text-o"></i> Detail</button></span></a>
