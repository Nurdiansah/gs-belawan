                ...
                <form method="post" action="simpan_bkk.php" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" disabled class="form-control is-valid" name="tgl_pengajuan" value="<?= formatTanggal($data2['release_on_bkk']); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <?php } elseif ($data2['pengajuan'] == 'BIAYA KHUSUS') { ?>
                            <div class="form-group">
                                <label for="remarks" class="col-sm-offset- col-sm-1 control-label">Remarks</label>
                                <div class="col-sm-3">
                                    <textarea rows="5" type="text" name="remarks" class="form-control" readonly><?php
            ...
            <div class="col-sm-12 col-xs-12">
                <div class="box box-warning">
                    ...
                    <div class="row">
                        ...
                        <?php
                        $cek_bp = !file_exists("../file/bukti_pembayaran/" . $data2['bukti_pembayaran'] . "");

                        if (!is_null($data2['bukti_pembayaran']) || $cek_bp) { ?>
                            <div class="col-sm-12">
                                <h3 class="text-center">Bukti Pembayaran</h3>
                                <!-- format pdf baru -->
                                <iframe src="../file/pdfjs/web/viewer.html?file=../../bukti_pembayaran/<?php echo $data2['bukti_pembayaran']; ?> " frameborder="0" width="100%" height="550"></iframe>
                            </div>
                        <?php } ?>
                    </div>
                </div>
