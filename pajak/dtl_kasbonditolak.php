...
$queryDetail =  mysqli_query($koneksi, "SELECT *, nilai_ppn / (nilai_jasa + nilai_barang) * 100 as ppn_persen
                                                         FROM kasbon k
...
$queryAnggaran = mysqli_query($koneksi, "SELECT * FROM anggaran WHERE id_divisi = '$Divisi' AND id_anggaran != '$id_anggaran' ORDER BY nm_item ASC");
        ...
        <div class="col-sm-12 col-xs-12">
            <div class="box box-primary">
                ...
                <div class="perhitungan">
                    <form method="post" name="form" action="reapprove_kasbon.php" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="form-group"> -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group">
                                            <span class="input-group-addon">Rp.</span>
                                            <input type="text" required class="form-control" value="<?= $data['nilai_barang']; ?>" name="nilai_barang" id="nilai_barang">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group">
                                            <span class="input-group-addon">Rp.</span>
                                            <input type="text" required class="form-control" value="<?= $data['nilai_jasa']; ?>" name="nilai_jasa" id="nilai_jasa" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="input-group">
                                            ...
                                            <input type="text" required min="0" max="10" class="form-control " name="ppn_persen" value="<?= round($data['ppn_persen']); ?>" id="ppn_persen" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <select name="id_pph" class="form-control">
                                            ...
                                            ?>
                                                    <option value="<?= $rowPph['id_pph']; ?>" <?php if ($rowPph['id_pph'] == $data['id_pph']) {
                                                                                                    echo "selected=selected";
                                                                                                } ?>><?= $rowPph['nm_pph'] ?></option>
                                            <?php endwhile;
                                            } ?>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group">
                                            ...
                                            <input type="text" required class="form-control" value="<?= $data['nilai_pph']; ?>" name="pph_nilai" id="pph_nilai">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-auto">
                                    ...
                                    <div class="form-group">
                                        <button class="btn btn-success col-sm-offset-6" type="submit" name="submit">Submit</button></span></a>
                                        &nbsp;
