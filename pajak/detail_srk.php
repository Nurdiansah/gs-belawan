...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="index.php?p=verifikasi_kasbon&sp=vk_sr">Daftar Kasbon SR</a></li>
...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-2 col-xs-3">
            <a href="index.php?p=verifikasi_kasbon&sp=vk_sr" class="btn btn-success"><i class="fa fa-backward"></i> Kembali</a>
        </div>
        <div class="col-sm-3 col-sm-offset-7 col-xs-offset-2 col-xs-3">
            ...
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#approveSr"><i class="fa fa-send"></i> Submit </button>
        </div>
        <br><br>
    </div>
                ...
                <div class="modal-body">
                    <form method="post" enctype="multipart/form-data" action="tolak_kasbon_sr.php" class="form-horizontal">
                        <div class="box-body">
                            ...
                            <input type="hidden" name="url" id="url" value="verifikasi_kasbon&sp=vk_sr">
                            <div class="mb-3">
    ...
    <div id="approveSr" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <!-- body modal -->
                <div class="modal-body">
                    <form method="post" enctype="multipart/form-data" action="setuju_kasbon_sr.php" class="form-horizontal">
                        <div class="box-body">
                            <input type="hidden" name="id" value="<?= $data['id_kasbon']; ?>">
                            <h4>Apakah anda yakin ingin mensubmit service request <b><?= $data['nm_barang']; ?> ? </b></h4>
                            <div class=" modal-footer">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <div class="input-group">
                                        <span class="input-group-addon">Rp.</span>
                                        <input type="text" readonly class="form-control " name="ppn_nilai" id="ppn_nilai" value="<?= round(formatRupiah2($data['nilai_ppn'])) ?>" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div id="fixed">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="input-group">
                                            <span class="input-group-addon">Rp.</span>
                                            <input type="text" readonly class="form-control " name="pph_nilai" value="<?= round($data['nilai_pph']) ?>" id="pph_nilai" />
                                        </div>
                                    </div>
                                </div>
                            </div>
