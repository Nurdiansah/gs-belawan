...
if (isset($_POST['rubah'])) {
    ...
    $queryUbah = mysqli_query($koneksi, "UPDATE bkk SET id_anggaran='$id_anggaran'
                                     WHERE id_bkk ='$id_bkk' ");
                    ...
                    <div class="form-group"> -->
                        ...
                        <div class="box-header with-border">
                            ...
                            <div class="col-sm-offset-9 col-sm-3 control-label">
                                ...
                                <a href="setuju_bkk.php?id=<?= $row2['id_bkk']; ?>"><span data-placement='top' data-toggle='tooltip' title='Kirim'><button class="btn btn-success">Done</button></span></a>
                    ...
                    <form method="post" enctype="multipart/form-data" action="" class="form-horizontal">
                        <div class="box-body">
                            <div class="form-group ">
                                ...
                                <div class="col-sm-4">
                                    <input type="hidden" value="<?= $idBkk ?>" class="form-control" name="id_bkk" readonly>
                                </div>
                            </div>
