<?php  
    ...
    include "../fungsi/fungsi.php";
        ...
        $queryDetail =  mysqli_query($koneksi, "SELECT * FROM detail_biayaops dbo
                                                         JOIN anggaran a
    ...
    <div class="row">
        <div class="col-sm-12 col-xs-12">
            <div class="box box-primary">
                ...
                <form method="post" name="form" action="auto_edit_item_mr.php" enctype="multipart/form-data" class="form-horizontal">
                        <div class="box-body">                                               
