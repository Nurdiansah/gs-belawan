...
if ($_POST['cetak']) {
    header("Location: cetak_rk04.php?tahun=" . enkripRambo($_POST['tahun']) . "&project=" . enkripRambo($_POST['project']) . "&divisi=" . enkripRambo($_POST['divisi']) . "&sub_divisi=" . enkripRambo($_POST['sub_divisi']) . "");
}
