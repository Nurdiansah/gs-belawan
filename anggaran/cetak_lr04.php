...
if (!isset($_SESSION['username_blw']) || $_SESSION['level_blw'] != "anggaran") {
    ...
    header("Content-Disposition: attachment; filename=LR04-" . $tahun . ".xls");
...
<?php } else {
    echo "<script>window.alert('Data laporan Sub Divisi (LR04) tidak ada/kosong!');
    				location='index.php?p=laporan_lr&sp=lr_04'
    			</script>";
} ?>