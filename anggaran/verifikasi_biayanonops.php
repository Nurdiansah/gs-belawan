<?php  
    ...
    if (isset($_GET['aksi']) && isset($_GET['id'])) {
        ...
        if ($_GET['aksi'] == 'detail') {
            header("location:?p=verifikasi_detailbiayanonops&id=$id");
        ...
        $query = mysqli_query($koneksi, "SELECT * 
                                ...
                                WHERE b.status_bkk='2' ORDER BY b.kd_transaksi DESC  ");    
                				...
                				<tr>
                					<?php 
                					 ...
                					 ?>
                						...
                						<td>
                                            <a href="?p=verifikasi_biayanonops&aksi=detail&id=<?= $row['id_bkk']; ?>"><span data-placement='top' data-toggle='tooltip' title='Lihat'><button  class="btn btn-info">Detail</button></span></a>                     
