...
if (!isset($_SESSION['username_blw']) || $_SESSION['level_blw'] != "anggaran") {
    ...
    header("Content-Disposition: attachment; filename=LR03-" . $tahun . ".xls");
...
<?php } else {
    echo "<script>window.alert('Data laporan Divisi (LR03) tidak ada/kosong!');
    				location='index.php?p=laporan_lr&sp=lr_03'
    			</script>";
} ?>