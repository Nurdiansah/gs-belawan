...
if (isset($_POST['simpan'])) {
    ...
    $query = mysqli_query($koneksi, "INSERT INTO anggaran (tahun, programkerja_id, id_divisi, id_segmen, no_coa, nm_coa, kd_anggaran, tipe_anggaran, jenis_anggaran, nm_item,
                                    januari_nominal, februari_nominal, maret_nominal, april_nominal, mei_nominal, juni_nominal, juli_nominal,
                                    agustus_nominal, september_nominal, oktober_nominal, november_nominal, desember_nominal, jumlah_nominal,
                                    created_by, created_on, last_modified_by, last_modified_on, row_version) VALUES
									('$tahun', '$program_kerja', '$id_divisi', '$segmen', '$no_coa', '$nm_coa', '$kd_anggaran', '$tipe_anggaran', '$jenis_anggaran', '$deskripsi', 
                                    '$nominal_januari', '$nominal_februari', '$nominal_maret', '$nominal_april', '$nominal_mei', '$nominal_juni', '$nominal_juli',
                                    '$nominal_agustus', '$nominal_september', '$nominal_oktober', '$nominal_november', '$nominal_desember', '$nominal_jumlah',
                                    '$nama', NOW(), '$nama', NOW(), '1');
			                ");
