...
if (isset($_POST['simpan'])) {
    ...
    $query = mysqli_query($koneksi, "INSERT INTO anggaran (tahun, programkerja_id, subheader_id, id_divisi, id_segmen, no_coa, nm_coa, kd_anggaran, tipe_anggaran, jenis_anggaran, nm_item, spj, `unlock`,
									...
									('$tahun', '$program_kerja', '$sub_header', '$id_divisi', '$segmen', '$no_coa', '$nm_coa', '$kd_anggaran', '$tipe_anggaran', '$jenis_anggaran', '$deskripsi', '$perdin', '$unlock',
