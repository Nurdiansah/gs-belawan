<?php  
    ...
    include "../fungsi/fungsi.php";
        ...
        $queryNama =  mysqli_query($koneksi, "SELECT nama , id_divisi from user WHERE username  = '$_SESSION[username]'");
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="id_anggaran" class="form-control" >
                                                <option value="<?=$row2['id_anggaram']; ?>"><?= $row2['kd_anggaran'].' '. $row2['nm_item'];  ?></option>                                                
                                                <?php                                                    
