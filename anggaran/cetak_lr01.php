...
if (!isset($_SESSION['username_blw']) || $_SESSION['level_blw'] != "anggaran") {
    ...
    header("Content-Disposition: attachment; filename=LR01-" . $tahun . ".xls");
...
<?php } else {
    echo "<script>window.alert('Data laporan Entitas (LR01) tidak ada/kosong!');
    				location='index.php?p=laporan_lr&sp=lr_01'
    			</script>";
} ?>